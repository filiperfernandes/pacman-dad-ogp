...
namespace pacman
{
    ...
    {
        public void createReplica(string pid, string pcs_url, string cli_srv_url, int msec_per_round, int num_players)
        {

            string args = pid + " " + pcs_url + " " + cli_srv_url + msec_per_round + num_players;
            string exe_path = Server.exe_path();
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("listening on tcp://" + PCS.GetLocalIPAddress() + ":1100/pcs");
